...
import { Heart, MessageCircle, Share2, Music, User as UserIcon, CheckCircle, Volume2, VolumeX, MoreVertical, Bookmark, Send, Plus, Video } from 'lucide-react';
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 overflow-hidden">
                ...
                <div className="overflow-hidden whitespace-nowrap">
                  ...
                  >
                    Original Audio • {reel.authorName} • Trending Music • STYN AFRICA
                  </motion.p>
                </div>
              </div>
            </div>
